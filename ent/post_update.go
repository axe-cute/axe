...
func (_u *PostUpdate) SetViews(v int64) *PostUpdate {
...
func (_u *PostUpdate) SetNillableViews(v *int64) *PostUpdate {
	if v != nil {
		_u.SetViews(*v)
	}
	return _u
...
func (_u *PostUpdate) AddViews(v int64) *PostUpdate {
...
func (_u *PostUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Views(); ok {
		_spec.SetField(post.FieldViews, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.AddedViews(); ok {
		_spec.AddField(post.FieldViews, field.TypeInt64, value)
	}
...
// SetViews sets the "views" field.
func (_u *PostUpdateOne) SetViews(v int64) *PostUpdateOne {
	_u.mutation.ResetViews()
	_u.mutation.SetViews(v)
	return _u
}
...
// SetNillableViews sets the "views" field if the given value is not nil.
func (_u *PostUpdateOne) SetNillableViews(v *int64) *PostUpdateOne {
	if v != nil {
		_u.SetViews(*v)
	}
	return _u
...
// AddViews adds value to the "views" field.
func (_u *PostUpdateOne) AddViews(v int64) *PostUpdateOne {
	_u.mutation.AddViews(v)
	return _u
}
